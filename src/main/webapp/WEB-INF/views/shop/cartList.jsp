...
<script src="/resources/jquery/jquery-3.3.1.min.js"></script>
 ...
 body { margin:0; pAddring:0; font-family:'맑은 고딕', verdana; }
 a { color:#05f; text-decoration:none; }
 a:hover { text-decoration:underline; }
 
 h1, h2, h3, h4, h5, h6 { margin:0; pAddring:0; }
 ul, lo, li { margin:0; pAddring:0; list-style:none; }
 ...
 footer#footer { background:#eee; pAddring:20px; }
 
 /* ---------- */
 
 header#header div#header_box { text-align:center; pAddring:30px 0; }
 header#header div#header_box h1 { font-size:50px; }
 header#header div#header_box h1 a { color:#000; }
 
 nav#nav div#nav_box { font-size:14px; pAddring:10px; text-align:right; }
 ...
 aside#aside li a { color:#000; display:block; pAddring:10px 0; }
 ...
 footer#footer div#footer_box { pAddring:0 20px; }
...
/*
 ...
 section#content div.goodsName { pAddring:10px 0; text-align:center; }
 section#content div.goodsName a { color:#000; }
 */
 section#content ul li { margin:10px 0; border-bottom: 1px solid #999; pAddring-bottom : 10px;}
 section#content ul li img { width:210px; height:210px; }
 ...
 section#content div.gdsInfo .delete button { font-size:22px; pAddring:5px 10px; border:1px solid #eee; background:#eee;}
</style>
<style>
...
.delBtn button { font-size:18px; pAddring:5px 10px; border:1px solid #eee; background:#eee;}

.checkBox { float:left; width:30px; }
.checkBox input { width:16px; height:16px; }
</style>
<style>
.listResult { pAddring:20px; background:#eee; }
.listResult .sum { float:left; width:45%; font-size:22px; }

.listResult .orderOpne { float:right; width:45%; text-align:right; }
.listResult .orderOpne button { font-size:18px; pAddring:5px 10px; border:1px solid #999; background:#fff;}
				...
				<ul>
						...
						<div class="delBtn">
							...
							<script>
								$(".selectDelete_btn").on("click", function(){
									var selDelConfirm = confirm("정말 삭제하시겠 습니까?");
									if(selDelConfirm){
					...
					<c:forEach items="${cartList }" var="cartList">
						<li>
							...
							<div class="thumb">
								<img src="/shop/display?fileName=${cartList.gdsThumnailImg }">
							</div>
							<div class="gdsInfo">
								<p>
									<span>상품명 : </span><a href="/shop/view?n=${cartList.gdsNum }">${cartList.gdsName }</a><br />
									<span>개당 가격 : </span><fmt:formatNumber value="${cartList.gdsPrice }" pattern="###,###,###"/> 원<br />
									<span>구입 수량 : </span>${cartList.cartStock } 개<br />
									<span>최종 가격 : </span><fmt:formatNumber value="${cartList.gdsPrice * cartList.cartStock}" pattern="###,###,###"/> 원<br />
								</p>
							<div class="delete">
								<button type="button" class="delete ${cartList.cartNum } btn" data-cartNum="${cartList.cartNum }">삭제</button>
																							<!-- 버튼을 클릭시 해당 카트번호를 가져오기 쉽도록 하기 위함 -->
								<script>
